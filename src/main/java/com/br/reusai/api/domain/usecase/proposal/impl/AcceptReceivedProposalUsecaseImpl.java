...
import com.br.reusai.api.domain.usecase.proposal.AcceptReceivedProposalUsecase;
...
public class AcceptReceivedProposalUsecaseImpl implements AcceptReceivedProposalUsecase {
    ...
    public void execute(String idProposal) {
        ...
        proposalGateway.updateProposalStatus(idProposal, StatusProposalEnum.ACCEPTED);
